...
public class OrderDAO extends JpaDAO<GameOrder> implements GenericDAO<GameOrder> {
	...
	public Double totalSales() {
		double sum = sumWithNamedQuery("GameOrder.sumTotal");
	...
	public Double totalTax() {
		double sum = sumWithNamedQuery("GameOrder.sumTax");
		BigDecimal bd = new BigDecimal(Double.toString(sum));
		bd = bd.setScale(2, RoundingMode.HALF_UP); // Làm tròn đến 2 chữ số thập phân
		return bd.doubleValue();
	}
	public Double totalShippingFee() {
		double sum = sumWithNamedQuery("GameOrder.sumShippingFee");
		BigDecimal bd = new BigDecimal(Double.toString(sum));
		bd = bd.setScale(2, RoundingMode.HALF_UP); // Làm tròn đến 2 chữ số thập phân
		return bd.doubleValue();
	}
	public Double totalSubToTal() {
		double sum = sumWithNamedQuery("GameOrder.sumSubToTal");
		BigDecimal bd = new BigDecimal(Double.toString(sum));
		bd = bd.setScale(2, RoundingMode.HALF_UP); // Làm tròn đến 2 chữ số thập phân
		return bd.doubleValue();
	}
