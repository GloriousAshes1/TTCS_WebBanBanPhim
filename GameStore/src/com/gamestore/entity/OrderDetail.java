...
@NamedQueries({
	...
	@NamedQuery(name = "OrderDetail.countByGame",
				query = "SELECT COUNT(*) FROM OrderDetail od WHERE od.game.gameId =:gameId")
...
public class OrderDetail implements java.io.Serializable {
	...
	public void setGameOrder(GameOrder bookOrder) {
		this.gameOrder = bookOrder;
		this.id.setGameOrder(bookOrder);
	}
